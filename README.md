...
Inspired by Notion, Trello, Slack, and Miro, this platform showcases modern software engineering design patterns, advanced OOP principles, and full-stack architecture.
...
* Use modern tools and clean architecture to create a scalable system.
* Deliver a platform that teams can use for planning, collaboration, and documentation.
...
* **Background Task Scheduler** (reminders + cleanup)
